...
public class PublisherEntity {
    ...
    public PublisherEntity(AddressEntity address, Set<de.hskl.itanalyst.buchservice.domain.model.BookEntity> books, String name) {
        this.name = name;
        setAddress(address);
        addBooks(books);
    }
    ...
    @ApiModelProperty(required = false)
    public void addBooks(Set<de.hskl.itanalyst.buchservice.domain.model.BookEntity> books) {
    ...
    public void updateBooks(Set<de.hskl.itanalyst.buchservice.domain.model.BookEntity> books) {
        if (null == books) return;
    ...
    public void removeBook(de.hskl.itanalyst.buchservice.domain.model.BookEntity book) {
