...
public class BuchlagerEntity {
    ...
    private de.hskl.itanalyst.buchservice.domain.model.BookEntity book;

    public BuchlagerEntity() {
        this(null, 0);
    }

    public BuchlagerEntity(de.hskl.itanalyst.buchservice.domain.model.BookEntity book, long amountInStock) {
    ...
    public de.hskl.itanalyst.buchservice.domain.model.BookEntity getBook() {
        return book;
    }
