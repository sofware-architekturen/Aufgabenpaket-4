...
public class AddressEntity {
    ...
    private final Set<de.hskl.itanalyst.buchservice.domain.model.PublisherEntity> publishers;
    ...
    public void removePublisher(de.hskl.itanalyst.buchservice.domain.model.PublisherEntity publisher) {
    ...
    public Set<de.hskl.itanalyst.buchservice.domain.model.PublisherEntity> getPublishers() {
