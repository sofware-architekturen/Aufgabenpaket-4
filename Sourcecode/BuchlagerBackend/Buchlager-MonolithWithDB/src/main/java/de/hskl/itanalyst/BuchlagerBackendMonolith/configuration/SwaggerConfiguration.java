package de.hskl.itanalyst.BuchlagerBackendMonolith.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .ignoredParameterTypes(AddressEntity.class, AuthorEntity.class, BookEntity.class, CartEntity.class, CartItemEntity.class, PublisherEntity.class)
